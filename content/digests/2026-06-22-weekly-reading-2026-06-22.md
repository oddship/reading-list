...
- Weekly reading: the model matters less than the surrounding system
- Weekly reading: durable agents, local models, and the new systems layer
- Weekly reading: logs, loops, filesystems, and the economics of open models
- Weekly reading: where AI turns back into systems engineering
