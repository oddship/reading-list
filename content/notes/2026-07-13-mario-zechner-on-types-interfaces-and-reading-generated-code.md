...
why_it_matters = "Useful follow-on to the 'own the mental model' debate because it grounds the abstraction in a concrete engineering control surface: types, interfaces, and the discipline to reject model-invented structure."
